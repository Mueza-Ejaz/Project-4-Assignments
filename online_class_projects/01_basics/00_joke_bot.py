...
# constants:
# Constants
PROMPT = "What do you want(joke)? "
JOKE = "Here is a joke for you! Debugging: Being the detective in a crime movie where you are also the murderer."
...
# What do you want(joke)? joke
# Here is a joke for you! Debugging: Being the detective in a crime movie where you are also the murderer.
